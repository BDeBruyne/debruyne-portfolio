    ...
    <div className='fixed w-full h-[130px] flex justify-between   items-center bg-white  text-black '>
        ...
        {/* Hamburger Dropdown Navigation for md and sm screen sizes */}
            ...
            <div className='hidden lg:flex fixed flex-col bottom-[0%] left-0'>
                <ul>
                    <li className='w-[140px] h-[60px] flex justify-between items-center ml-[-80px] hover:ml-[-10px] duration-500 bg-white' target="_blank" rel="noopener noreferrer">
                    ...
                    <li className='w-[130px] h-[60px] flex justify-between items-center ml-[-70px] hover:ml-[-10px] duration-500 bg-white'>
                    ...
                    <li className='w-[140px] h-[60px] flex justify-between items-center ml-[-80px] hover:ml-[-10px] duration-500 bg-white'>
