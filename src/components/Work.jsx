...
const Work = () => {
    return (
      <div name='work' className='w-full h-screen bg-[white]'>
        {/* Container */}
        <div className='max-w-[1000px] mx-auto flex flex-col justify-center w-full h-full pt-16 sm:pb-32'>
            <div class='centerText max-w-[1000px] w-full' >
                <p  className='text-5xl border-b-4 text-[#ff7300] border-[#125b83] border-double'>Work</p>
